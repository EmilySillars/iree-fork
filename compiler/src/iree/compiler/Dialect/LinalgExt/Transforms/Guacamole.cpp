// Hello World Pass for IREE
// Count instructions and functions in the input program
//
...
#define GEN_PASS_DEF_GUACAMOLEPASS
...
namespace {
struct GuacamolePass final
    : impl::GuacamolePassBase<GuacamolePass> {
...
} // namespace mlir::iree_compiler::IREE::Guacamole
